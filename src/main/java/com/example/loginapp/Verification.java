...
public class Verification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button verifybuttonclick = findViewById(R.id.verify);
        ...
        textView.setText(String.format(
                "+91-%s", getIntent().getStringExtra("inputmobile")
        ));

        getotpbackend = getIntent().getStringExtra("backendotp");

        final ProgressBar progressBarverifyotp = findViewById(R.id.progessbarverification);
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(Verification.this, "Otp sended Succussfully", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
            }
